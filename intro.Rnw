...
Le projet \textsf{RStudio} tend à s'imposer l'environnement de développement
de référence pour \textsf{R}, d'autant qu'il a l'avantage d'être libre,
gratuit et multiplateforme. Son installation est décrite
...
la page de téléchargement et de sélectionner el fichier correspondant à son
