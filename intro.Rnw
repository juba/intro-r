...
Giraud, et Joël Gombin pour leurs corrections et
suggestions. Et un remerciement plus particulier à Milan Bouchet-Valat pour sa
relecture très attentive et ses nombreuses et légitimes remarques.
...
\item il n'existe pas encore d'interface graphique pour \R équivalente
  ...
  \textsf{Modalisa}\footnotemark. \R fonctionne à l'aide de scripts (des petits
...
\item utiliser les options de pondération des fonctions
  usuelles ou les fonctions de l'extension \questionr pour les cas
  les plus simples~;
