...
\begin{rstudio}
  ...
  retrouver un objet que vous avez créé \emdash par exemple, appuyez sur la touche 
  \texttt{<Tabulation>} après avoir saisi \texttt{mean(t} \emdash ou bien pour retrouver
  un argument nommé d'une fonction \emdash par exemple, appuyez sur la touche 
