...
L'auteur tient à remercier Mayeul Kauffmann, Julien Biaudet et Frédérique
Giraud pour leurs corrections et suggestions.
...
(\texttt{[1]}, \texttt{[21]} et \texttt{[41]}). En fait ces nombres
entre crochets indiquent la position du premier élément de la ligne
dans notre vecteur. Ainsi, le 124 en début de deuxième ligne est le
21ème élément du vecteur, tandis que le 169 de la troisième ligne est
à la 42ème position.
